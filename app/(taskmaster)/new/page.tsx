...
function WizardContent() {
  ...
  const handleNext = () => {
    ...
    setDirection(1);
    router.push(`/new?step=${step < 4 ? step + 1 : '4'}`);
  };
        ...
        : step === 5 && generatedData ? (
          ...
          : (
            ...
            <>
              ...
              <div className="flex-none pt-5 px-6 pb-4 shadow-sm z-10">
                <div className="flex justify-between items-center mb-2">
                  <button onClick={handleBack} className="text-gray-500 hover:text-gray-800 active:scale-95 rounded-2xl px-2 py-2 hover:bg-gray-400/20 flex items-center justify-center font-medium transition-all duration-150">
                    {step === 1 ? <span className='leading-none text-sm'>Cancel</span> : <span className="flex text-sm items-center justify-center gap-1.5 leading-none">
